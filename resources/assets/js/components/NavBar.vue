    ...
    <nav class="navbar navbar-light navbar-full ">
        <div class="container">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item"><router-link to="/module/add" class="nav-link"><i class="fa fa-fw fa-plus-circle" aria-hidden="true"></i> Add Module</router-link></li>
            </ul>
                    ...
                    <div v-if="user">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right" aria-labelledby="responsiveNavbarDropdown">
                                <router-link to="/module/add" class="dropdown-item">
